...
###############################################################################
def notch_reject_filter(shape, d0=3, ftype='butterworth', n=4, u_k=0, v_k=0):
...
###############################################################################
def filter_image_freq(img, fclass='notchreject', ftype='butterworth', d0=160, w=20, n=2, u_k=0, v_k=0):
